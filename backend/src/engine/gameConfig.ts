...
export const REEL_STRIPS: number[][] = [
  strip(['10', 'J', 'Q', 'K', 'A', '10', 'J', 'Star', 'Q', 'K', 'A', '10', 'J', 'Q', 'K', 'Scatter', 'A', '10', 'J', 'Q', 'Wild', 'K', 'A']),
  strip(['J', 'Q', 'K', 'A', '10', 'J', 'Q', 'K', 'Star', 'A', '10', 'J', 'Q', 'K', 'A', '10', 'J', 'Scatter', 'Q', 'K', 'A', '10', 'J']),
  strip(['Q', 'K', 'A', '10', 'J', 'Q', 'K', 'A', '10', 'J', 'Star', 'Q', 'K', 'A', '10', 'J', 'Q', 'K', 'Scatter', 'A', '10', 'J', 'Q']),
  strip(['K', 'A', '10', 'J', 'Q', 'K', 'A', '10', 'J', 'Q', 'K', 'Star', 'A', '10', 'J', 'Q', 'K', 'A', '10', 'Scatter', 'J', 'Q', 'K']),
  strip(['A', '10', 'J', 'Q', 'K', 'A', '10', 'J', 'Q', 'K', 'A', '10', 'J', 'Star', 'Q', 'K', 'A', '10', 'J', 'Q', 'Scatter', 'K', 'A']),
];
...
export const SCATTER_FREE_SPINS: [number, number][] = [[3, 5], [4, 10], [5, 20]];
